...
def signup(request):
    if request.method == "POST":
        ...
        myuser.save()
        messages.success(request, "Your Account has been created and activated succesfully!!")
...
def signin(request):
    if request.method == 'POST':
        ...
        if user is not None:
            ...
            return render(request, "ssms/index.html",{"fname":fname})
        else:
